...
import { ArrowLeft, Upload, Scissors, RotateCw, Type, Smile, Download, Plus, Trash2, Send, Wand2, ZoomIn, ZoomOut, Image as ImageIcon, Package, Check, Eraser, MousePointer2, Undo2, Redo2, X, ArrowUp, ArrowDown } from 'lucide-react';
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[20px] p-4 shadow-sm border border-transparent dark:border-gray-800 flex-1 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4 w-full">
              ...
              <button 
                ...
                className={`flex flex-col items-center gap-1 p-2 min-w-[64px] rounded-xl transition-colors ${selectedId ? 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300' : 'text-gray-400 opacity-50 cursor-not-allowed'}`}
                disabled={!selectedId}
              >
                <ArrowUp size={20} />
          ...
          <div className="bg-white dark:bg-[#1E293B] rounded-[24px] w-full max-w-sm p-6 shadow-2xl animate-in zoom-in-95">
            ...
            <div className="mb-4 flex gap-2">
              <select
                ...
                className="flex-1 bg-[#F5F6F8] dark:bg-[#0F172A] border-none rounded-[14px] py-2 px-3 text-gray-900 dark:text-white focus:ring-2 focus:ring-[#25D366] outline-none"
              >
